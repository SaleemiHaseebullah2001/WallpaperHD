...
if (!$email) {
   ...
   if($error!=""){
   echo "<div class='errorrp'>".$error."</div>
        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <figure><img src="images/Forgot password-bro.svg" alt="sing up image"></figure>
                    <a href="Login.php" class="signup-image-link">or go back to login</a>
                </div>

                <div class="signin-form">
                    <h2 class="form-title">Forgot Password</h2>
                    <form action="ForgotPassword.php" method="POST" class="register-form" id="login-form">
